...
- [x] Вынести p-value на отдельный график  
...
- [x] Участок, на котором видим отклонения, выделить цветом для статьи/дисера  
- [x] Записывать измерения в табличку  
- [x] Нарисовать пучки атласа  
- [x] Right/Left патологии  
